...
CONFIG_UPLOAD_DIRECTORIES_KEY: str = "upload_directories"
...
ENV_UPLOAD_DIRECTORIES: str = "UPLOAD_DIRECTORIES"
...
ERROR_UPLOAD_DIRECTORY_NOT_ALLOWED: str = "Upload directory is not allowed."
